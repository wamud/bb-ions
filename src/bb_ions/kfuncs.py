...
We convert from k = {0, 1, 2, ... , 2lm - 1} to row / column (v / w) notation by defining (v, w) = (⌊k/m⌋ , k mod m). These are standard conversion definitions to arrange into groups of m --
note the value of v only goes up by 1 every m elements and w cycles through m elements, hence a row and column.

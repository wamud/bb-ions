...
if [ -d "../circuits/helios/exclude_opp_basis_detectors/parallel_gates/" ]; then
    cp -r "../circuits/helios/exclude_opp_basis_detectors/parallel_gates/" "${SCRATCH}"
fi
...
cd ${SCRATCH}
python3 ${PBS_O_WORKDIR}/run_parallel.py

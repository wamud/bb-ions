...
def main():
    ...
    circuit_paths = glob.glob(f"../circuits/without_leakage/exclude_vs_include/*.stim") 
    csv_path = f"../collected_stats/helios_noise/without_leakage/without_leakage_exclude_vs_include_2.csv"
    ...
    existing =  glob.glob(f"../collected_stats/helios_noise/without_leakage/*without_leakage_exclude_vs_include*.csv") 

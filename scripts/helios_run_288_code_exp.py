...
def main():
    ...
    circuit_paths = glob.glob(f"../circuits/helios/exclude_opp_basis_detectors/288_code_copy/*.stim")
    circuit_paths.sort()

    
    csv_path = f"../collected_stats/helios_noise_288_code_long_chain_BPOSD_settings.csv"

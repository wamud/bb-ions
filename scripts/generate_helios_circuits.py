...
# Generate circuits:
for code in [bb6_756_code()]: #[bb6_360_code(), bb6_72_12_6_code(), bb6_90_8_10_code(), bb6_108_code(), gross_code(), two_gross_code()]:
...
# for code in [ bb8_72_14_8_code(), bb8_144_14_14_code(), bb8_216_14_20_code(), bb8_64_14_8_code(), bb8_128_14_12_code(), bb8_192_14_20_code()]:
    ...
    num_syndrome_extraction_cycles = 10 # Just going to do 10 to try reduce decoding complexity
    ...
    for p in ps:
        ...
        circuit.to_file(f"../circuits/{noise}/{prefix}_opp_basis_detectors/756_code/{filename}.stim")

...
for p in [0.001]:
    ...
    Aij = entry['Aij']
    Bij = entry['Bij']
    if l > m: # swap roles of l and m (and x and y) for an equivalent code because as we are simulating something with m pairs of operation zone legs so want m > l
    ...
    # Save circuit:
    circuit.to_file(f"../circuits/leakage_and_loss/480_40/{filename}.stim")

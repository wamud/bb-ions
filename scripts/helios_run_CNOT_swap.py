...
def main():
    ...
    circuit_paths = glob.glob(f"../circuits/helios/exclude_opp_basis_detectors/compare_CNOT_swap_LRC/*.stim") 
    circuit_paths.sort()
    ...
    csv_path = f"../collected_stats/helios_noise/swap_LRC_helios.csv"
